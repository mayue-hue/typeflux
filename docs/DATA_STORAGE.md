...
| `voice.processing.timeoutSeconds` | Int | Base AI rewrite wait time for short source text (1, 3, 5, 10, or 30 seconds; default 3). Longer source text receives an automatically extended timeout, capped at 90 seconds. Legacy 60-second values migrate to 30. |
