...
enum MouseVoiceHandleGeometry {
    static let canvasSize = CGSize(width: 56, height: 56)
    static let buttonSize: CGFloat = 30
    static let iconSize: CGFloat = 18
    static let ringDiameter: CGFloat = 36
    static let interactionInset: CGFloat = 6
    static let maximumMagneticOffset: CGFloat = 3
    static let maximumRingLineWidth: CGFloat = 3.15
